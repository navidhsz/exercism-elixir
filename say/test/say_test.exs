defmodule SayTest do
  ...
  # @tag :pending
  test "five hundred twenty-three" do
    assert Say.in_english(523) == {:ok, "five hundred twenty-three"}
  end
  ...
  # @tag :pending
  test "nine thousand nine hundred ninety-nine" do
    assert Say.in_english(9_999) == {:ok, "nine thousand nine hundred ninety-nine"}
  end

  # @tag :pending
  test "ten thousand" do
    assert Say.in_english(10_000) == {:ok, "ten thousand"}
  end

  # @tag :pending
  test "ninety-nine thousand twenty-two" do
    assert Say.in_english(99_022) == {:ok, "ninety-nine thousand twenty-two"}
  end

  # @tag :pending
  test "one hundred thousand" do
